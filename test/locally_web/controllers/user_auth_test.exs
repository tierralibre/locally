defmodule LocallyWeb.UserAuthTest do
  use LocallyWeb.ConnCase, async: true

  alias Locally.Accounts
  alias LocallyWeb.UserAuth
  import Locally.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LocallyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LocallyWeb.Endpoint.subscribe(live_socket_id)
